            ...
            {clientList.length > 0 && (() => {
              ...
              return (
                <div style={{ padding: '8px 0 2px', display: 'flex', alignItems: 'center' }}>
                  <span className="bold" style={{ flex: 1, fontSize: 17, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>합계</span>
                  <span className="num subtle" style={{ fontSize: 17 }}>{totalWeeks}주</span>
                  <span className="num bold" style={{ marginLeft: 10, minWidth: 40, textAlign: 'right', fontSize: 17, color: team.color }}>
                    {totalBilling.toFixed(1)}<span style={{ marginLeft: 2, fontWeight: 400, fontSize: 14, color: 'var(--text-subtle)' }}>주</span>
                  </span>
                </div>
              );
            })()}
